                      ...
                      {selectedModes.includes("remote") && (
                        <PreferredLocationsInput
                          ...
                          hint={
                            ...
                            "a listing that names no region is never ruled out. Type a region such as Europe, EU, or APAC " +
                            "and pick it from the Regions group — it expands to every member country."
                          }
