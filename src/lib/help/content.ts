...
export const helpPages: HelpPage[] = [
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "A salary question uses the range from the posting if it has one, and always your saved target from your profile. If the posting has no range, the app looks up the market range for the role while it makes your resume, without making you wait for it. Draft answers straight after a resume and the research may not have finished yet, so the salary answer rests on your saved target alone. Draft the answers again a minute later to include the research.",
      ...
      },
      {
        ...
        bullets: [
          ...
          "The card shows who Clay will look for: two likely hiring leaders, two leaders close to the team, and one recruiter. It also shows the title phrases used for each search.",
          "Job Search Terminal uses the job description on your machine to prepare those title phrases. Clay receives the company identifier and displayed titles, not the job description, resume, notes, or application answers.",
          "The three searches can return no more than five people in total and may use allowance for five Clay search results. You choose when to run them; the app never searches on its own.",
          "The Clay API connection in Job Search Terminal is separate from a Clay MCP connection in ChatGPT.",
  ...
  },
  {
    ...
    sections: [
      ...
      {
        id: "people-search",
        title: "Find relevant people is unavailable",
        bullets: [
          "Open the job's Outreach tab and read the Before Clay searches checklist. Every item marked Required must be completed before the button turns on.",
          "If Clay is not connected, follow the link to Account → Settings → Integrations, save your Clay API key, and test the connection. A Clay MCP connection in ChatGPT does not connect Job Search Terminal.",
          "If the company is missing, open Overview → Edit job details and add the hiring company's name.",
          "For Company website or LinkedIn page, use the employer's own website, domain, or LinkedIn company page. Do not paste a LinkedIn job, Indeed, Glassdoor, or other job-board link.",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Generated outreach is always a draft. Review and edit it before copying it to LinkedIn or email.",
        ],
      },
    ],
